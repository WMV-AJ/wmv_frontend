  ...
  useEffect(() => {
    ...
    try {
      ...
      images.forEach((src, index) => {
        ...
        const frameMaterial = new THREE.MeshStandardMaterial({ color: index === 0 ? 0xbfc1c3 : 0x74777a, metalness: .73, roughness: .31 });
      ...
      const orbitMaterial = new THREE.MeshStandardMaterial({ color: 0xbfc1c3, metalness: .8, roughness: .31, transparent: true, opacity: .63 });
      ...
      const edge = new THREE.PointLight(0xc8b582, 22, 15); edge.position.set(4, -2, 5); scene.add(edge);
