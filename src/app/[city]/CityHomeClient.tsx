...
// Space Grotesk 500 carries all card/list titles; Playfair italic survives
// ONLY on the hero "Tonight in <city>" headline.
...
function SectionHeader({ label, right, onClick }: {
  ...
  return (
    ...
    >
      <div style={{ fontFamily: grotesk, fontSize: 14, fontWeight: 700, letterSpacing: '1.4px', textTransform: 'uppercase', color: T.accent, display: 'flex', alignItems: 'center', gap: 6 }}>
        {label}
      </div>
      {right}
    </div>
      ...
      <div style={{ maxWidth: 430, margin: '0 auto', paddingBottom: 40 }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 20 }}>
              <button
                ...
                style={{
                  fontFamily: grotesk, fontSize: 12, fontWeight: 700, letterSpacing: '0.8px',
          ...
          {loading
            ...
            : [
              ...
              <div key={i} style={{
                ...
                {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                <div style={{ fontFamily: grotesk, fontWeight: 400, fontSize: 28, color: (s as any).live ? T.live : T.ink, lineHeight: 1 }}>
                  {s.n}
                </div>
                ...
                : happeningNow.map((e) => (
                  ...
                  >
                    ...
                    <div style={{ paddingTop: 8 }}>
                      <div style={{ fontFamily: grotesk, fontWeight: 500, fontSize: 13, color: T.ink, lineHeight: 1.2, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                        {e.name || ''}
                      </div>
                      {e.event_time && (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ paddingTop: 9 }}>
                          ...
                          <div style={{
                            fontFamily: grotesk, fontWeight: 500, fontSize: 15,
                            color: T.ink, lineHeight: 1.2, letterSpacing: '-0.01em',
              ...
              {tonightEvents.slice(0, 4).map((e, i) => {
                ...
                <div key={e.event_id || e.venue_id || i} style={{
                  ...
                  <div style={{ minWidth: 0 }}>
                    ...
                    <div style={{
                      fontFamily: grotesk, fontWeight: 500, fontSize: 16,
                      color: T.ink, letterSpacing: '-0.01em', lineHeight: 1.15, marginTop: 2,
                    }}>
                      {e.name || e.venue}
                    </div>
              ...
              {dealsTonight.map((e: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Venue name — white, no gold (color discipline) */}
                    <div style={{ fontFamily: grotesk, fontWeight: 500, fontSize: 14, color: T.ink, marginTop: 4, letterSpacing: '-0.01em', lineHeight: 1.15, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {e.name || ''}
                    </div>
                    <div style={{ fontFamily: mono, fontSize: 8, color: T.inkMuted, marginTop: 3, letterSpacing: '0.5px' }}>
            ...
            {vibeGrid.map((v) => {
              ...
              return (
                <div key={v.id}
                  ...
                  <span style={{
                    fontFamily: grotesk, fontWeight: 500, fontSize: 13,
            ...
            {loading ? (
              ...
              weekendByDay.filter(d => d.events.length > 0).map(({ ds, label, events }) => (
                <div key={ds} style={{ marginBottom: 18 }}>
                  ...
                  >
                    <span style={{ fontFamily: grotesk, fontWeight: 500, fontSize: 16, color: T.ink, letterSpacing: '-0.01em' }}>
                      {label}
                    </span>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{ paddingTop: 8 }}>
                            ...
                            <div style={{
                              fontFamily: grotesk, fontWeight: 500, fontSize: 15, color: T.ink, lineHeight: 1.2, marginTop: 2,
            ...
            {loading
              ...
              : storiesData.map((s, i) => (
                <div key={s.id} style={{
                  ...
                  <div style={{ paddingTop: 8 }}>
                    <div style={{
                      fontFamily: grotesk, fontWeight: 500, fontSize: 10, color: T.ink,
        ...
        <div style={{ padding: '24px 18px 0' }}>
          <div style={{ borderTop: `1px solid ${T.line}`, paddingTop: 14 }}>
            <div style={{ fontFamily: grotesk, fontSize: 14, fontWeight: 700, letterSpacing: '1.4px', textTransform: 'uppercase', color: T.accent, marginBottom: 8 }}>
              The method
            </div>
            <div style={{ fontFamily: grotesk, fontWeight: 500, fontSize: 19, color: T.ink, letterSpacing: '-0.01em', lineHeight: 1.25 }}>
