...
function SpecCell({
  ...
  return (
    <div style={{
      ...
      <div style={{ fontFamily: displayFont, fontSize: 18, lineHeight: 1.1, color: valueColor, marginTop: 6 }}>
        {value}
      </div>
        ...
        >
          <div style={{ paddingBottom: 104 }}>
            ...
            <div style={{ padding: '0 20px 0', marginTop: -104, position: 'relative', zIndex: 2 }}>
                ...
                <h1 style={{ fontFamily: displayFont, fontWeight: 400, fontSize: 40, lineHeight: 0.96, letterSpacing: '-0.03em', margin: '12px 0 0', color: T.ink }}>
                  {event.event_name}
                </h1>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontFamily: displayFont, fontSize: 13, color: T.inkMuted, marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
