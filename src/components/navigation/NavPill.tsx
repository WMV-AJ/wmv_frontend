  ...
  return (
    <div
      style={{
        ...
        // Gold rim so the toggle reads as a control rather than another dark
        // blob on a dark map, with a matching outer glow to lift it off the
        // basemap. T.accent is the same gold as the active MAP segment.
        border: `1.5px solid ${T.accent}`,
        boxShadow: `0 8px 32px rgba(0,0,0,0.6), 0 0 14px ${T.accentSoft}, inset 0 1px 0 rgba(255,255,255,0.06)`,
      }}
    >
