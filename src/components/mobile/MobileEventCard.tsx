  ...
  return (
    ...
    <div
      ...
      style={darkMode ? {
        ...
        // Top and right only. borderLeft/Bottom stay hairline so the card
        // still reads as a panel against the map rather than a torn edge.
    ...
    >
      ...
      <div className="flex gap-3 p-3.5">
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          {/* 3. Tag — category pill in the accent colour, then the event's
                 own subtitle. Both are optional, so the row collapses. */}
          {(accentCategory || event.event_subtitle) && (
            <div className="flex items-center gap-2 mt-2 min-w-0">
              {accentCategory && (
                <span
                  className="text-[10px] font-bold uppercase tracking-wide px-2.5 py-1 rounded-full whitespace-nowrap flex-shrink max-w-[55%] truncate"
        ...
        {/* ── Right: 9:16 still, with the expand control floating on it ── */}
